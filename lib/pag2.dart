          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                /*Verifica se o usuário preencheu todos os campos, caso não, irá retornar
                 um alerta pedindo para revisar os campos*/ 
                if (nome.isEmpty || idade.isEmpty || curso.isEmpty || cidade.isEmpty || pais.isEmpty) {
                  showDialog(
                    ...
                    builder: (context) => AlertDialog(
                      title: Text("Atenção!"),
                      content: Text(
                          "Por Favor Preencha todos os dados do Cadastro!"),
                      actions: [
                        TextButton(
                  ...
                  /*Retornará uma confirmação de conclusão do cadastro, mostrando
                   os dados preenchidos pelo usuário*/ 
                } else {
                  showDialog(
                    context: context,
                    builder: (context) => AlertDialog(
